...
public class MotionProfile extends Command {
    ...
    public MotionProfile(List<Pose2d> points) {
		...
		yPoints = new ArrayList<>();
	   	...
	   	path = g.generateTrajectory(points, 2, 0.0, 0.0, 11, 3, false);		
	...
	protected void initialize() {
		...
		//0.0121
		//0.097 .18
		follower = new FalconTrajectoryFollower(path, 3, true, 0, 0);
	...
	protected void execute() {
		...
		Robot.driveTrain.tankDrive(-follower.getLeftVelocity()/9 , follower.getRightVelocity()/9);
